...
public class HelloWorldRestController {
    ...
    @Autowired
    UserProfileService userProfileService;  //Service which will do all data retrieval/manipulation work
    ...
    public ResponseEntity<Void> createUser(@RequestBody User user, UriComponentsBuilder ucBuilder) {
        ...
        if (userProfileService.isUserExist(user)) {
    ...
    public ResponseEntity<User> updateUser(@PathVariable("id") long id, @RequestBody User user) {
        ...
        User currentUser = userProfileService.findById(id);
        ...
        userProfileService.updateUser(currentUser);
